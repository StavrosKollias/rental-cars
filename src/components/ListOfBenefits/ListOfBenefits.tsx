...
export const ListOfBenefits: React.FC<IListOfBenefitsProps> = ({ content }) => {
  return (
    <div className="list-of-benefits-container" data-testid="list-of-benefits-container">
      {content.map((e, i) => {
        return (
          <div key={i} className="flex">
            <span data-testid="list-of-benefits-icon" aria-hidden="true">
            ...
            <div>
              <div data-testid="list-of-benefits-messages">{e}</div>
            </div>
          </div>
        )
      })}
